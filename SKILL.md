...
name: sleep-memory
description: >-
  【睡眠记忆·四层架构】Agent 分层记忆：工作记忆 / Gety 热检索 / Obsidian 巩固笔记 / Memory MCP 实体事实。
...
| L2 | 热检索 | Gety CLI / MCP | 缺信息时按需拉片段 |
| L3 | 巩固笔记 | Obsidian Markdown | 日复盘、会话巩固、录音摘要 |
| L4 | 实体事实 | Memory MCP | 跨会话短事实（无密钥明文） |
...
- 模板：[references/nightly-template.md](references/nightly-template.md)
